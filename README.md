...
An Android app (Python embedded via Chaquopy, foreground service, in-app config/cookie editor) lives in [`android/`](android/README.md). Push to GitHub and Actions builds the APK for you — no local toolchain needed. On-device clients use `http://127.0.0.1:8081/v1` as the Base URL.
